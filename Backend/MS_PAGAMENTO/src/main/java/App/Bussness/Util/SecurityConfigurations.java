    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return  httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/ms_pagamentoauth/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/ms_pagamentoauth/register").permitAll() //hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/Ms_pagamento/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/Ms_pagamento/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/Ms_pagamento/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/Ms_pagamento/**").permitAll()
